class Md5 {
    private static rotateLeft(lValue, iShiftBits): any{
    ...
    private static ff(a,b,c,d,x,s,ac) {
        a = md5.addUnsigned(a, md5.addUnsigned(md5.addUnsigned(((b & c) | ((~b) & d)), x), ac));
        return md5.addUnsigned(md5.rotateLeft(a, s), b);
    };

    private static gg(a,b,c,d,x,s,ac) {
        let g = (b & d) | (c & (~d));
        a = md5.addUnsigned(a, md5.addUnsigned(md5.addUnsigned(g, x), ac));
        return md5.addUnsigned(md5.rotateLeft(a, s), b);
    };

    private static hh(a,b,c,d,x,s,ac) {
        a = md5.addUnsigned(a, md5.addUnsigned(md5.addUnsigned((b ^ c ^ d), x), ac));
        return md5.addUnsigned(md5.rotateLeft(a, s), b);
    };

    private static ii(a,b,c,d,x,s,ac) {
        a = md5.addUnsigned(a, md5.addUnsigned(md5.addUnsigned((c ^ (b | (~d))), x), ac));
        return md5.addUnsigned(md5.rotateLeft(a, s), b);
    };


    public static hash(obj: any): string{
        ...
        str = md5.utf8Encode(str);

        x = md5.convertToWordArray(str);
